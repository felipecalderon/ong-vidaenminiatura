    ...
    <section id="valores">
      ...
      <div className="grid sm:grid-cols-2 gap-4 md:gap-6">
        {valores.map((v, i) => (
          <div
            key={v.titulo}
            className="group relative overflow-hidden rounded-2xl border border-outline-variant/60 bg-surface p-7 md:p-8 hover:shadow-sm transition-shadow duration-300"
          >
            ...
            <div className="relative z-10 flex gap-5">
              <div className="shrink-0 mt-1">
                <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-linear-to-br from-primary/10 to-primary/5 border border-primary/10 group-hover:border-primary/20 group-hover:shadow-sm transition-[border-color,box-shadow] duration-300">
