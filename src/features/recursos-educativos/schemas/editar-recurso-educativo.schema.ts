...
export const editarRecursoEducativoSchema = z.object({
  id: z.string().uuid("ID de recurso educativo inválido"),
  titulo: z
    .string()
...
export type EditarRecursoEducativoInput = z.infer<
  typeof editarRecursoEducativoSchema
>;
