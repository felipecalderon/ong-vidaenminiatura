...
import { useCrearRecursoEducativoForm } from "../hooks/use-crear-recurso-educativo-form";

interface CrearRecursoEducativoFormProps {
  categorias: { id: string; nombre: string }[];
}

export function CrearRecursoEducativoForm({
  categorias,
}: CrearRecursoEducativoFormProps) {
  const {
    state,
    formAction,
    isPending,
    ...
    >
      ...
      <div className="space-y-2">
        ...
        <Input
          id="titulo"
          name="titulo"
          placeholder="Ej. ¿Qué es un polinizador y por qué importa?"
      ...
      <div className="space-y-2">
        ...
        <Select
          name="tipo"
          defaultValue={state.fields?.tipo || TipoRecursoEducativo.CONCEPTO}
